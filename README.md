...
| `delete_transit_network.yml`               | `lab.azure_infrastructure_config_demos.transit_peered_networks`                                                                                                                           | Deletes AWS resources created in the `create_transit_network` playbook.                                                                        |
